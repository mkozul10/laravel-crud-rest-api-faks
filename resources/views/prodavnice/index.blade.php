...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="fw-bold text-primary">Popis prodavnica</h1>
        <a href="{{ route('prodavnice.create') }}" class="btn btn-success shadow-sm">Nova prodavnica</a>
    </div>
        ...
        <div class="card mb-4 border-0 shadow rounded" style="background-color: #f8f9ff;">
            <div class="card-body">
                <h4 class="card-title text-dark-emphasis mb-3">
                    <span class="text-primary">{{ $prodavnica->naziv }}</span>
                </h4>
                ...
                <div class="d-flex flex-wrap gap-2 mt-3">
                    <a href="{{ route('prodavnice.show', $prodavnica) }}" class="btn btn-outline-primary btn-sm">
                        Prikaži
                    </a>
                    <a href="{{ route('prodavnice.edit', $prodavnica) }}" class="btn btn-outline-warning btn-sm">
                        Uredi
                    </a>
    ...
    @empty
        <div class="alert alert-info">
            Trenutno nema prodavnica za prikaz.
        </div>
    @endforelse
